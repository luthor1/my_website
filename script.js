document.addEventListener("DOMContentLoaded", function () {
    ...
    const videoList = [
       //  { title: "", url: "../videolar2/2 (1).mp4", thumbnail: "../resimler2/2 (1).png", category: "category1", description: "" },
        ...
        { title: "Kzıl şehvet", url: "videolar/2.mp4", thumbnail: "resimler/2.png", category: "category2", description: "Taş gibi hatunu sikiyor keyifli seyirler efendim ;)" },
        ...
        { title: "Maşallah kafası kadar diyor", url: "videolar/4.mp4", thumbnail: "resimler/4.png", category: "category2", description: "Keyifli seyiler ;)" },
        ...
        { title: "İnci gibi kızdan sakso", url: "videolar/7.mp4", thumbnail: "resimler/7.png", category: "category1", description: "Taş gibi liseli sevgilisine sakso çektiriyor" }, 
         ...
         { title: "Ev sahibini sikiyor", url: "videolar/8.mp4", thumbnail: "resimler/8.png", category: "category1", description: "Sarışın ev sahibine geçiriyor." },
         { title: "İçime boşal diyor", url: "videolar/9.mp4", thumbnail: "resimler/9.png", category: "category1", description: "Azgınlıktan gözü dönmüş" },
